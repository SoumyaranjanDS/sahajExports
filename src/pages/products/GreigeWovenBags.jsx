...
const GreigeWovenBags = () => {
  // Hardcoded Product Data for Greige Woven Bags
  const product = {
    id: "greige-woven-bags",
    name: "Greige Woven Bags",
    description: "Our collection of greige woven bags showcases the epitome of quality and functionality, designed for global export. Meticulously crafted from superior raw materials, these greige woven bags offer a perfect fusion of durability, flexibility, and adaptability. Suited for a myriad of applications, our range features various compositions, weaves, and finishes to meet the diverse needs of industries around the world.",
    specifications: {
      "Material": "Cotton, Polyester, Cotton-Polyester Blends, Organic Cotton (customizable)",
      ...
      "Finish": "Choices include regular greige, bleached greige, and specialty finishes"
    },
    features: [
      {
        title: "High-Quality Material",
        description: "Raw materials selected for their robustness, longevity, and performance."
      },
      {
        title: "Versatile Weaves",
        description: "Multiple weave options to cater to the specific demands of various industries."
      },
      {
        title: "Customization",
    ...
    exportCapabilities: {
      "Minimum Order Quantity": "Flexibility to accommodate both small-scale and large-scale manufacturing.",
      "Shipping": "Tailored solutions in weave, weight, and finish to meet specific client requirements. With custom printing.",
      "Custom Orders": "Tailored solutions in weave, weight, and finish to meet specific client needs."
    },
    coreValues: [
      {
        title: "Premium Quality",
        description: "Sourced and processed with precision to meet the highest industry standards."
      },
      {
        title: "Versatility",
        description: "Diverse options to cater to the unique needs of different industries."
      },
      {
        title: "Customer-Centric Approach",
        description: "Committed to delivering greige woven bags that surpass customer expectations in quality and performance."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262431/sahaj/products/textiles/Greige_Woven_Bags.png')` // Tote bag imagery
          }}
        ></div>
...
export default GreigeWovenBags;

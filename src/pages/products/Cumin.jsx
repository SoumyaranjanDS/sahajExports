...
const Cumin = () => {
  // Hardcoded Product Data for Cumin
  const product = {
    id: "cumin",
    name: "Cumin",
    description: "Our Premium Indian Cumin Seeds are carefully selected from the best agricultural regions of India, renowned for their quality and flavor. These seeds are harvested at the peak of their maturity, ensuring a rich aroma and robust taste that is essential in various cuisines around the world.",
    specifications: {
      "Quality": "100% natural, no additives or preservatives",
      "Packaging": "Available in various sizes (50g, 100g, 500g, 1kg) and packaging options (vacuum-packed, jars, bulk bags) to meet diverse needs",
      "Grade": "Premium Export Quality",
      "Usage": "Indian cumin is a staple in numerous dishes worldwide, especially in Indian, Middle Eastern, and North African cuisines. It’s perfect for seasoning meats, vegetables, soups, and sauces, and is an essential ingredient in curry powders and spice blends.",
      "Certifications": "ISO Certified, HACCP Compliant, FSSAI Approved"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "1000 kg",
      "Shipping": "Worldwide shipping with reliable logistic partners",
      "Customization": "Labeling and packaging can be customized as per the buyer’s requirements"
    },
    coreValues: [
      {
        title: "Authentic Indian Flavor",
        description: "Our cumin seeds bring the authentic taste of Indian spices to your kitchen."
      },
      {
        title: "Stringent Quality Control",
        description: "Each batch undergoes rigorous quality checks to ensure purity and flavor."
      },
      {
        title: "Competitive Pricing",
        description: "We offer the best quality at competitive prices, making our cumin seeds a valuable addition to your product line."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262423/sahaj/products/spices/Cumin.png')` // Spices imagery
          }}
        ></div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-16">
        ...
        <motion.div
          ...
          className="mb-24 flex flex-col lg:flex-row gap-16 pt-12"
        >
          {/* Left: Big Heading */}

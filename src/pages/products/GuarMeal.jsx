...
const GuarMeal = () => {
  // Hardcoded Product Data for Guar Meal
  const product = {
    id: "guar-meal",
    name: "Guar Meal",
    description: "Our Natural Choice Guar Meal is a by-product of guar gum production, derived from the guar bean. It is highly nutritious and an excellent source of protein and fiber, making it a popular ingredient in animal feed. Known for its high digestibility and palatability, our Guar Meal is an economical yet effective feed additive.",
    uses: [
      {
        title: "Cattle Feed",
        description: "Enhances milk yield and improves overall health."
      },
      {
        title: "Poultry Feed",
        description: "Contributes to better growth and egg production."
      },
      {
        title: "Aquaculture",
        description: "Aids in the healthy growth of fish and other aquatic species."
      }
    ],
    specifications: {
      "Quality": "Rich in protein (40-45%) and fiber",
      "Forms Available": "Guar Meal Korma and Guar Meal Churi",
      "Packaging": "Available in various packaging options including bags and bulk (20kg, 50kg, 1MT, etc.)",
      "Shelf Life": "12 months from the date of manufacture",
      "Nutritional Value": "High protein content makes it an excellent feed ingredient. Good source of digestible fiber.",
      "General Uses": "Widely used as a cost-effective and nutritious feed ingredient.",
      "Certifications": "ISO Certified, FSSAI Approved"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, accommodating both small and large orders",
      "Shipping": "Efficient and reliable global shipping solutions",
      "Customization": "Customized packaging based on client requirements"
    },
    coreValues: [
      {
        title: "Nutritional Quality",
        description: "A high protein and fiber content makes it an excellent feed additive."
      },
      {
        title: "Economical",
        description: "Offers a cost-effective alternative to traditional animal feed ingredients."
      },
      {
        title: "Sustainability",
        description: "Produced as a by-product, contributing to environmental sustainability."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262404/sahaj/products/agro/Guar_Meal.png')` // Animal feed/grains imagery
          }}
        ></div>

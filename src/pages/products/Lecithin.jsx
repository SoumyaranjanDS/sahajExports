...
import { ArrowLeft, ChevronRight, Droplet, Star } from 'lucide-react';

const Lecithin = () => {
  // Hardcoded Product Data for Lecithin
  const product = {
    id: "lecithin",
    name: "Lecithin",
    description: "Our Superior Soy Lecithin is extracted from the finest quality soybeans, offering both Non-GMO and GMO options to cater to diverse customer preferences and industry requirements. Known for its versatility, soy lecithin is widely used as an emulsifier, stabilizer, and preservative in various food, pharmaceutical, and cosmetic products.",
    varieties: [
      {
        title: "Non-GMO Soy Lecithin",
        description: "Extracted from soybeans cultivated without genetic modification. Ideal for organic and natural product lines."
      },
      {
        title: "GMO Soy Lecithin",
        description: "A more economical option sourced from high-yield GMO soy crops. Suitable for a wide range of conventional food and industrial applications."
      }
    ],
    uses: [
      {
        title: "Food Industry",
        description: "Used in chocolates, baked goods, salad dressings, etc., for improving texture and shelf life."
      },
      {
        title: "Pharmaceuticals",
        description: "Acts as a softening agent in medications and supplements."
      },
      {
        title: "Cosmetics",
        description: "Commonly used in skincare and makeup products for its moisturizing properties."
      }
    ],
    specifications: {
      "Type": "Liquid and Powder form available",
      "Purity": "High lecithin content with minimal impurities",
      "Packaging": "Customizable (bottles, bulk drums, bags, etc.)",
      "Safety Standards": "Meets international food safety and quality guidelines",
      "Quality Checks": "Rigorous testing for consistency and purity"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Negotiable based on requirements",
      "Delivery": "Worldwide shipping with trusted logistic partners"
    }
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262407/sahaj/products/agro/Lecithin.png')` // Liquid drop / oil / abstract imagery
          }}
        ></div>

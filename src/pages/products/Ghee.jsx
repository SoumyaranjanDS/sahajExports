...
const Ghee = () => {
  // Hardcoded Product Data for Ghee
  const product = {
    id: "ghee",
    name: "Ghee",
    description: "Our Ghee collection boasts the purest forms of A1 and A2 Ghee, sourced from premium dairy using the traditional Bilona and cream-based extraction methods. Renowned for its rich flavour and health benefits, our ghee stands out for its quality and purity.",
    varieties: [
      {
        title: "A1 Ghee (Bilona Method)",
        description: "Extracted via the traditional Bilona process to retain natural nutrients and aroma. Rich, aromatic, and packed with fat-soluble vitamins and antioxidants. Ideal for Ayurvedic practices and traditional cooking."
      },
      {
        title: "A2 Ghee (Cream-Based)",
        description: "Crafted using the cream-based method for a smooth texture and robust flavor profile. Rich in Omega-3 fatty acids and CLA, offering versatile use in daily culinary applications and baking."
      }
    ],
    specifications: {
      "Source": "Sourced from free-range, grass-fed cows ensuring purity and authenticity",
      "Packaging": "Available in various sizes (250ml, 500ml, 1L, etc.) and eco-friendly packaging options",
      "Quality": "100% natural, free from additives or preservatives",
      "Shelf Life": "Typically 12 months under recommended storage conditions",
      "Nutritional Value": "Source of healthy fats, vitamins A, D, E, and K, aiding in better absorption of nutrients",
      "Certifications": "ISO Certified, FSSAI Approved"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, catering to retail and bulk orders",
      "Shipping": "Efficient global delivery with robust logistics",
      "Custom Orders": "Tailored packaging and processing available as per client specifications"
    },
    coreValues: [
      {
        title: "Authenticity",
        description: "Pure A1 and A2 Ghee derived through traditional extraction methods."
      },
      {
        title: "Premium Quality",
        description: "Carefully sourced and processed to maintain purity and nutritional richness."
      },
      {
        title: "Health Benefits",
        description: "Known for its digestive properties and nutritional value, enhancing overall well-being."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262402/sahaj/products/agro/ghee.png')` // Premium golden liquid abstract
          }}
        ></div>

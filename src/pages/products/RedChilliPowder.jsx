...
const RedChilliPowder = () => {
  // Hardcoded Product Data for Red Chilli Powder
  const product = {
    id: "red-chilli-powder",
    name: "Red Chilli Powder",
    description: "Spice Emporium’s Red Chilli Powder Collection offers an extensive array of choices for exporters and spice enthusiasts around the globe. Our selection includes a wide spectrum of flavors, from mild and aromatic to intensely hot, capturing the essence of Indian chili varieties. This range is perfect for those seeking to explore the rich and diverse world of Indian spices.",
    varieties: [
      {
        title: "Kashmiri Chilli Powder",
        description: "Known for its vibrant color and mild heat."
      },
      {
        title: "Guntur Chilli Powder",
        description: "Famous for its fiery heat and robust flavor."
      },
      {
        title: "Byadagi Chilli Powder",
        description: "Offers a unique blend of moderate heat and a sweet aroma."
      },
      {
        title: "Rajapuri Chilli Powder",
        description: "A perfect balance of heat and flavor, widely used in traditional Indian cooking."
      },
      {
        title: "Regional Varieties",
        description: "Each with its own unique taste and heat profile."
      }
    ],
    specifications: {
      "Quality": "100% pure, natural, and free from additives",
      "Processing": "Ground using traditional and modern methods to retain flavor and color",
      "Shelf Life": "Typically 12-18 months, stored in a cool, dry place",
      "Applications": "Ideal for culinary uses, from seasoning meats to being a key ingredient in masalas, marinades, and sauces.",
      "Certifications": "ISO Certified, FSSAI Approved, Organic Certification (if applicable)"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible to suit both small-scale and bulk requirements",
      "Shipping": "Reliable and efficient global shipping capabilities",
      "Customization": "Tailored packaging and labeling as per buyer’s needs"
    },
    coreValues: [
      {
        title: "Diverse Selection",
        description: "Catering to all taste preferences and culinary needs."
      },
      {
        title: "Authentic Indian Flavors",
        description: "Each variety offers a unique taste of India's rich spice heritage."
      },
      {
        title: "Stringent Quality Control",
        description: "Ensuring purity, intensity, and consistency in every batch."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262428/sahaj/products/spices/Red_Chilli_Powder.png')` // Red Chili/Spices imagery
          }}
        ></div>

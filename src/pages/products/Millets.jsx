...
const Millets = () => {
  // Hardcoded Product Data for Millets
  const product = {
    id: "millets",
    name: "Millets",
    description: "Our Global Harvest Millets collection offers a versatile and nutritious range of millet varieties, each boasting unique health benefits and culinary uses. As a globally cherished crop, these millets are not only excellent for human consumption but also play a significant role in agricultural sustainability.",
    varieties: [
      {
        title: "Pearl Millet",
        description: "High in protein and fiber, perfect for bread and porridges."
      },
      {
        title: "Foxtail Millet",
        description: "Rich in antioxidants and iron, ideal for salads and pilafs."
      },
      {
        title: "Barnyard Millet",
        description: "Gluten-free and high in calcium, suitable for porridge and baking."
      },
      {
        title: "Finger Millet",
        description: "Packed with calcium and amino acids, great for traditional dishes and baking."
      },
      {
        title: "Proso Millet",
        description: "Contains significant protein and is easy to digest, versatile in cooking."
      },
      {
        title: "Kodo Millet",
        description: "High in fiber and antioxidants, used in traditional and modern recipes."
      },
      {
        title: "Little Millet",
        description: "Nutrient-dense and fast-cooking, perfect for quick meals."
      }
    ],
    specifications: {
      "Quality": "100% natural, non-GMO",
      "Packaging": "Available in various sizes (500g, 1kg, 5kg, etc.) and packaging options (eco-friendly, vacuum-packed, bulk bags)",
      "Shelf Life": "Typically 12 months under proper storage conditions",
      "Nutritional Value": "Rich in vitamins, minerals, and dietary fiber, making them an excellent addition to a healthy diet. They are also gluten-free.",
      "Uses": "Incredibly versatile in culinary applications, from traditional dishes to modern, health-conscious recipes. Can be used in baking, as a rice substitute, in salads, and even in brewing.",
      "Certifications": "ISO Certified, Organic Certification (if applicable), FSSAI Approved"
    },
    exportCapabilities: {
    ...
    coreValues: [
      {
        title: "Wide Variety",
        description: "A range of millet types to cater to diverse dietary needs and preferences."
      },
      {
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262409/sahaj/products/agro/Millets.png')` // Grains/Millets imagery
          }}
        ></div>

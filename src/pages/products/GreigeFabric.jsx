...
const GreigeFabric = () => {
  // Hardcoded Product Data for Greige Fabric
  const product = {
    id: "greige-fabric",
    name: "Greige Fabric",
    description: "Explore the epitome of textile excellence with our high-quality greige fabrics, expertly tailored for global export. Crafted from premium raw materials, our wovens offer durability and flexibility, while our knitted fabrics provide a soft yet strong embrace. Versatile compositions, weaves, and finishes cater to diverse industries, ensuring your products meet the highest standards. Elevate your creations with our carefully curated collection, a perfect fusion of strength, flexibility, and adaptability.",
    specifications: {
      "Material": "Cotton, Polyester, Cotton-Polyester Blends, Organic Cotton",
      "Weave": "Dobby, Plain, Twill, Satin, and more",
      "Weight": "Available in different weights to suit diverse requirements",
      "Width": "Various width options for flexibility in manufacturing",
      "Finish": "Options include regular greige, bleached greige, and specialty finishes",
      "Certifications": "ISO Certified, OEKO-TEX® Standard 100, Fair Trade Certification"
    },
    features: [
      {
        title: "High-Quality Material",
        description: "Raw materials selected for strength, durability, and performance."
      },
      {
        title: "Versatile Weaves",
        description: "Diverse weave options to meet the specific needs of different industries."
      },
      {
        title: "Customization",
        description: "Tailored finishes and specifications available for specialized applications."
      }
    ],
    applications: [
      {
        title: "Textile Manufacturing",
        description: "Ideal for garment manufacturers, home textiles, and more."
      },
      {
        title: "Apparel Production",
        description: "Suitable for creating a variety of clothing items, from casual wear to formal attire."
      },
      {
        title: "Home Furnishings",
        description: "Perfect for crafting quality bedding, draperies, and upholstery."
      }
    ],
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, accommodating both small-scale and large-scale manufacturing.",
      "Shipping": "Worldwide shipping with reliable logistics partners",
      "Custom Orders": "Tailored solutions in weave, weight, and finish to meet specific client needs."
    },
    coreValues: [
      {
        title: "Premium Quality",
        description: "Carefully sourced and processed to meet the highest industry standards."
      },
      {
        title: "Versatility",
        description: "Diverse options to cater to the unique requirements of different industries."
      },
      {
        title: "Customer-Centric Approach",
        description: "Committed to delivering fabrics that exceed customer expectations in quality and performance."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262429/sahaj/products/textiles/Greige_Fabric.png')` // Greige Fabric imagery
          }}
        ></div>

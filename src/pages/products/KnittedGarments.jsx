...
import { ArrowLeft, ChevronRight, Droplet, Sparkles, Shirt } from 'lucide-react';

const KnittedGarments = () => {
  // Hardcoded Product Data for Knitted Garments
  const product = {
    id: "knitted-garments",
    name: "Knitted Garments",
    description: "Global Trendz offers a range of high-quality garment t-shirts, perfect for international export. Our t-shirts are made from the finest cotton and blended fabrics, ensuring comfort, durability, and style. Suitable for a variety of markets and fashion needs, our t-shirts come in an array of designs, sizes, and colors, catering to both casual and formal preferences.",
    specifications: {
      "Material": "100% Cotton, Cotton-Polyester Blends, Organic Cotton (options available)",
      "Sizes": "Available in a comprehensive range from XS to XXL",
      "Designs": "A wide variety of designs including plain, printed, embroidered, and custom designs",
      "Colors": "A broad spectrum of colors from classic whites and blacks to vibrant hues",
      "Packaging": "Individually packed, with options for custom branding and bulk packaging",
      "Certifications": "ISO Certified for Quality Management, OEKO-TEX® Standard 100, Fair Trade"
    },
    features: [
      {
        title: "Quality Fabric",
        description: "Soft, breathable, and long-lasting materials."
      },
      {
        title: "Fashion-Forward Styles",
        description: "From classic cuts to contemporary designs, suitable for diverse fashion tastes."
      },
      {
        title: "Customization",
        description: "We offer customized branding, printing, and embroidery services."
      }
    ],
    applications: [
      {
        title: "Retail Fashion",
        description: "Ideal for clothing retailers looking for quality and variety."
      },
      {
        title: "Promotional Wear",
        description: "Suitable for businesses seeking branded t-shirts for events, promotions, or uniforms."
      },
      {
        title: "Bulk Supply",
        description: "Perfect for wholesalers and distributors seeking high-quality t-shirts for resale."
      }
    ],
    exportCapabilities: {
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262435/sahaj/products/textiles/Knitted_Garments.png')` // T-shirts imagery
          }}
        ></div>
...
export default KnittedGarments;

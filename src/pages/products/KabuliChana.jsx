...
const KabuliChana = () => {
  // Hardcoded Product Data for Kabuli Chana
  const product = {
    id: "kabuli-chana",
    name: "Kabuli Chana",
    description: "Our Kabuli Chana is known for its large size, smooth coat, and creamy color. It’s a staple in various cuisines and is revered for its versatility, nutritional value, and delightful taste.",
    specifications: {
      "Quality": "100% Natural, Non-GMO",
      "Packaging": "Custom packaging available in various sizes (1kg, 5kg, 25kg, etc.) in materials like jute bags, PP bags, and bulk containers",
      "Shelf Life": "12 months from the date of packaging under ideal storage conditions",
      "Nutritional Value": "Rich in protein, dietary fiber, and essential nutrients like iron, phosphorus, and B vitamins",
      "Uses": "Perfect for a range of culinary applications, including salads, soups, stews, hummus, and traditional dishes like chana masala.",
      "Certifications": "ISO Certified"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Negotiable, accommodating both small and large orders",
      "Shipping": "Worldwide shipping with reliable logistic partners",
      "Customs Handling": "Assistance with all necessary export documentation and procedures"
    },
    coreValues: [
      {
        title: "Superior Quality and Taste",
        description: "Our chickpeas are renowned for their exceptional quality, size, and taste."
      },
      {
        title: "Strict Quality Control",
        description: "Each batch undergoes rigorous quality checks to ensure the finest product."
      },
      {
        title: "Competitive Pricing",
        description: "We offer premium Kabuli Chana at competitive prices, making it a great value for international markets."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262406/sahaj/products/agro/Kabuli_Chana.png')` // Grains imagery
          }}
        ></div>

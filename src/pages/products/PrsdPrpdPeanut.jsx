...
const PrsdPrpdPeanut = () => {
  // Hardcoded Product Data for PRSD/PRPD Peanut
  const product = {
    id: "prsd-prpd-peanut",
    name: "PRSD/PRPD Peanut",
    description: "Our Indian Delight PRSD/PRPD Peanuts collection offers a diverse range of flavors from traditional Indian cuisine. Each variety is carefully crafted to bring out the unique tastes and textures that Indian peanuts are famous for. Whether you’re looking for the bold spices of masala, the classic taste of salted peanuts, the fiery zest of spicy peanuts, or something uniquely regional, our collection has it all.",
    varieties: [
      {
        title: "Masala Peanuts",
        description: "Coated with a blend of traditional Indian spices for a tangy and flavorful experience."
      },
      {
        title: "Salted Peanuts",
        description: "Perfectly roasted and lightly salted for a classic and satisfying crunch."
      },
      {
        title: "Spicy Peanuts",
        description: "Infused with hot spices for those who love an extra kick. Customizable packaging (bottles, bulk drums, bags, etc.)"
      },
      {
        title: "Regional Specialties",
        description: "Unique flavors inspired by various Indian regions, offering an authentic taste of India’s diverse culinary heritage."
      }
    ],
    specifications: {
      "Quality": "Premium, hand-selected peanuts",
      "Processing": "Hygienically processed and roasted to perfection",
      "Packaging": "Available in a variety of sizes and packaging options, including nitrogen-flushed packets for extended freshness",
      "Shelf Life": "Typically 6-9 months, depending on storage conditions",
      "Health Benefits": "Rich in protein, fiber, and healthy fats. A perfect snack for health-conscious consumers.",
      "Usage": "Ideal as a snack, in party mixes, or as an addition to various culinary preparations.",
      "Certifications": "FSSAI Certified, ISO 9001:2015 Quality Management System"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, catering to both small and large-scale requirements",
      "Global Shipping": "Efficient worldwide delivery with proper packaging ensuring product integrity",
      "Custom Orders": "We accommodate custom flavor profiles and packaging designs based on client needs"
    },
    coreValues: [
      {
        title: "Diverse Flavors",
        description: "A wide array of flavors catering to various tastes and preferences."
      },
      {
        title: "Top-Quality Ingredients",
        description: "Only the finest peanuts and spices are used, ensuring a premium product."
      },
      {
        title: "Customizable Solutions",
        description: "We offer tailored options to meet specific market and client demands."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262412/sahaj/products/agro/PRPD_Peanut.png')` // Bowl of snacks/peanuts imagery
          }}
        ></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {product.varieties.map((variety, idx) => (
                <motion.div 
                  key={idx}
                  whileHover={{ y: -5 }}
                  className="bg-white p-8 rounded-3xl shadow-lg shadow-black/5 border border-black/5 flex flex-col"
                >

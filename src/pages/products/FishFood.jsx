...
const FishFood = () => {
  // Hardcoded Product Data for Fish Meal
  const product = {
    id: "fish-meal",
    name: "Fish Meal",
    description: "Our Premium Aquatic Nutrition Solution. Our Fish Meal is a superior feed ingredient carefully crafted from high-quality fish, ensuring a nutritious and palatable option for the aquaculture industry. Sourced from a variety of fish species, our product is available in both sterilized and dry forms, meeting the diverse nutritional needs of fish and other aquatic species.",
    specifications: {
      "Quality": "Enriched with essential proteins and Omega-3 fatty acids",
      "Forms Available": "Sterilized Fish Meal and Dry Fish Meal",
      "Shelf Life": "12 months from the date of manufacture",
      "Uses": "Widely used as a cost-effective and nutritious feed ingredient",
      "Certifications": "ISO Certified, FSSAI Approved"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, accommodating both small and large orders",
      "Shipping": "Reliable global shipping solutions for prompt delivery",
      "Customization": "Customized packaging based on client requirements"
    },
    coreValues: [
      {
        title: "Nutritional Quality",
        description: "Rich in proteins and Omega-3 fatty acids, ensuring optimal health and growth"
      },
      {
        title: "Economical",
        description: "Cost-effective and sourced responsibly, contributing to environmental and ethical considerations."
      },
      {

...
const WheatFlour = () => {
  // Hardcoded Product Data for Wheat Flour
  const product = {
    id: "wheat-flour",
    name: "Wheat Flour",
    description: "Introducing our delightful range of wheat flour bursting with flavor and nutrition, our flour varieties promise to elevate your culinary creations to new heights. Whether you’re a seasoned baker or a kitchen novice, there’s something for everyone in our collection. Each type of flour is carefully crafted to ensure the highest quality and taste, perfect for baking bread, cakes, pastries, and more.",
    healthBenefits: [
      {
        title: "High in Nutrients & Fiber",
        description: "Packed with essential nutrients, including B vitamins, iron, magnesium, and dietary fiber. Crucial for maintaining energy levels and supporting metabolic processes."
      },
      {
        title: "Lower Risk of Heart Disease",
        description: "The fiber, antioxidants, and plant compounds in wheat help improve cholesterol levels and lower blood pressure, contributing to a healthier heart."
      },
      {
        title: "Lower Risk of Stroke",
        description: "High fiber content helps maintain healthy blood pressure and prevents the buildup of plaque in arteries, reducing the likelihood of stroke."
      },
      {
        title: "Reduce Risk of Obesity",
        description: "More filling than refined flour due to higher fiber content, helping control appetite and reduce overall calorie intake."
      },
      {
        title: "Lower Risk of Type 2 Diabetes",
        description: "Improves insulin sensitivity and lowers blood sugar levels by slowing down the absorption of sugar into the bloodstream."
      },
      {
        title: "Support Healthy Digestion",
        description: "Aids in digestion by adding bulk to the stool and promoting regular bowel movements, preventing constipation."
      }
    ],
    specifications: {
      "Moisture": "10.50%",
      "Sedimentation Value": "20ml",
      "Wet Gluten": "25.58%",
      "Dry Gluten": "7.42%",
      "Ash": "1.23%",
      ...
      "Falling No": "351 Sec",
      "Water Absorption": "70%",
      "Alcoholic Acidity": "0.07%",
      "Starch Damage": "8.68",
      "Granularity": "80.0% (throughs of 150 micron)",
      "Uses": "Chapati/Roti Test: Puffing observed, Softness normal, creamish brown in colour, taste and odor natural."
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, accommodating both retail and bulk orders",
      "Shipping": "Robust logistics for efficient global delivery",
      "Custom Orders": "We offer customized packaging and processing as per buyer requirements"
    },
    coreValues: [
      {
        title: "Wide Variety",
        description: "A range of Wheat flour types to cater to diverse dietary needs and preferences."
      },
      {
        title: "Superior Quality",
        description: "Sourced and processed with a focus on quality and natural cultivation."
      },
      {
        title: "Health Benefits",
        description: "Offering a nutritious alternative to traditional grains."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262414/sahaj/products/agro/wheat_flour.png')` // Wheat/Flour imagery
          }}
        ></div>

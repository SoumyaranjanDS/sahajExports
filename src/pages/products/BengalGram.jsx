...
const BengalGram = () => {
  // Hardcoded Product Data for Bengal Gram
  const product = {
    id: "bengal-gram",
    name: "Bengal Gram",
    description: "Our Authentic Indian Bengal Gram is a top-tier agricultural product, famous for its nutty flavor and nutritious profile. Cultivated in the fertile lands of India, this variety of chickpeas is an integral part of Indian cuisine and is gaining popularity worldwide for its versatility and health benefits.",
    specifications: {
      "Quality": "High-grade, naturally cultivated",
      "Size": "Available in various sizes catering to different market needs",
      "Shelf Life": "Up to 12 months with proper storage",
      "Nutritional Value": "Rich in protein, dietary fiber, and essential minerals like iron, manganese, and folate",
      "Uses": "Ideal for a variety of dishes such as curries, salads, soups, and as a base for flours and pastes.",
      "Certifications": "ISO Certified"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, accommodating both small and bulk orders",
      "Shipping": "Efficient and reliable global shipping",
      "Customization": "Customized packaging and labeling as per buyer requirements"
    }
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262396/sahaj/products/agro/Bengal_Gram.png')` // Lentils/Beans imagery
          }}
        ></div>

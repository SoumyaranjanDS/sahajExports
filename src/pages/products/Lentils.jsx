...
const Lentils = () => {
  // Hardcoded Product Data for Lentils
  const product = {
    id: "lentils",
    name: "Lentils",
    description: "Our Authentic Indian Legacy Lentils Collection features a diverse array of lentils, each known for their distinctive taste, texture, and versatility. These lentils are an essential part of Indian cuisine and are increasingly popular globally due to their nutritional value and culinary adaptability.",
    varieties: [
      {
        title: "Red Lentils (Masoor Dal)",
        description: "Known for their quick-cooking nature and sweet, nutty flavor, perfect for soups and purees."
      },
      {
        title: "Green Lentils (Moong Dal)",
        description: "Retain their shape well when cooked, ideal for salads and side dishes."
      },
      {
        title: "Brown Lentils",
        description: "Earthy flavor, great for stews and casseroles."
      },
      {
        title: "Black Lentils (Urad Dal)",
        description: "Rich and hearty, commonly used in Indian dals and curries."
      },
      {
        title: "Yellow Lentils (Toor Dal)",
        description: "Mild and sweet, often used in traditional Indian cooking."
      }
    ],
    specifications: {
      "Quality": "100% natural, non-GMO, and free from additives",
      "Packaging": "Available in various sizes (500g, 1kg, 5kg, etc.) and packaging options (plastic bags, vacuum packs, bulk bags)",
      "Shelf Life": "Typically 12 months under proper storage conditions",
      "Nutritional Value": "High in protein, fiber, and essential nutrients, making them a healthy addition to any diet.",
      "Uses": "Versatile in use, perfect for traditional Indian dishes, contemporary global cuisine, vegetarian and vegan diets, and health-conscious meal planning.",
      "Certifications": "ISO Certified, FSSAI Approved"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Negotiable",
      "Shipping": "Worldwide shipping with efficient and reliable logistics",
      "Customization": "Packaging and product specifications can be tailored to meet buyer requirements"
    },
    coreValues: [
      {
        title: "Diverse Selection",
        description: "Catering to various tastes and culinary needs."
      },
      {
        title: "Superior Quality",
        description: "Stringently selected and processed for the best quality."
      },
      {
        title: "Competitive Pricing",
        description: "Offering great value without compromising on quality."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262408/sahaj/products/agro/Lentils.png')` // Assorted lentils imagery
          }}
        ></div>

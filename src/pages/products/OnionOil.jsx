...
import { ArrowLeft, ChevronRight, Droplet, Sparkles, Box } from 'lucide-react';

const OnionOil = () => {
  // Hardcoded Product Data for Onion Oil
  const product = {
    id: "onion-oil",
    name: "Onion Oil",
    description: "Essence of Nature Onion Oil is a premium product extracted from high-quality onions. Known for its distinctive aroma and numerous benefits, our onion oil is a popular choice in various industries, including cosmetics, pharmaceuticals, and aromatherapy. It is carefully processed to retain all the natural goodness and potency of onions.",
    specifications: {
      "Quality": "100% pure, natural, and free from additives",
      "Extraction Method": "Steam distillation or cold-pressing, ensuring high potency and purity",
      "Packaging": "Various sizes (30ml, 50ml, 100ml) and types (glass, aluminum, bulk)",
      "Shelf Life": "Typically 18-24 months in a cool, dry place away from direct sunlight",
      "Certifications": "ISO Certified, Organic Certification (if applicable), GMP Compliant"
    },
    keyBenefits: [
      {
        title: "Hair Care",
        description: "Promotes hair growth, reduces hair fall, and improves scalp health."
      },
      {
        title: "Skin Care",
        description: "Known for its antibacterial properties, it helps in skin rejuvenation and treating acne."
      },
      {
        title: "Aromatherapy",
        description: "Often used for its soothing and calming properties."
      }
    ],
    applications: [
      {
        title: "Cosmetics",
        description: "Used in hair oils, shampoos, and skincare products."
      },
      {
        title: "Pharmaceuticals",
        description: "Employed in formulations for its therapeutic properties."
      },
      {
        title: "Aromatherapy",
        description: "Utilized in diffusers and massage oils for its unique scent and benefits."
      }
    ],
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible to accommodate both small and large orders",
      "Shipping": "Efficient global shipping with robust packaging to ensure product integrity",
      "Customization": "Available to meet specific packaging and labeling requirements"
    },
    coreValues: [
      {
        title: "Purity Guaranteed",
        description: "Extracted using methods that preserve the natural essence and benefits of onions."
      },
      {
        title: "Versatility",
      ...
      },
      {
        ...
        description: "Rigorously tested for quality and effectiveness."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262419/sahaj/products/oil/Onion_Oil.png')` // Oil imagery
          }}
        ></div>

...
const PepperOleoresins = () => {
  // Hardcoded Product Data for Pepper Oleoresins
  const product = {
    id: "pepper-oleoresins",
    name: "Pepper Oleoresins",
    description: "Pepper Oleoresins represent the pinnacle of flavor and quality. Derived from meticulously selected black pepper, our oleoresins capture the rich and intense flavors of this renowned spice. Ideal for a variety of culinary and industrial applications, our oleoresins are a testament to the robust and aromatic character of Indian black pepper.",
    specifications: {
      "Quality": "Extracted using state-of-the-art technology to preserve flavor and aroma",
      "Concentration": "High-potency oleoresins, offering intense flavor and aroma",
      "Packaging": "Various options, including food-grade drums and containers",
      "Shelf Life": "Extended shelf life, ensuring lasting freshness and potency",
      "Flavor Profile": "Rich, warm, and woody flavor with a sharp pungency typical of high-quality black pepper",
      "Certifications": "ISO Certified, FSSAI Approved, Compliant with global food safety standards"
    },
    applications: [
      {
        title: "Food Industry",
        description: "Used as a flavoring agent in processed foods, meats, marinades, and seasonings."
      },
      {
        title: "Pharmaceuticals",
        description: "Employed for its potential health benefits and as a flavoring agent in medicinal products."
      },
      {
        title: "Cosmetics",
        description: "Incorporated in products for its fragrance and potential skin benefits."
      }
    ],
    exportCapabilities: {
      "Minimum Order Quantity": "Flexible, catering to both small-scale and bulk requirements",
      "Shipping": "Robust global logistics network ensuring prompt and safe delivery",
      "Customs Handling": "Expertise in handling export procedures and documentation"
    },
    coreValues: [
      {
        title: "Authentic Indian Flavor",
        description: "Extracted from high-quality Indian black pepper, offering an unmatched flavor profile."
      },
      {
        title: "Advanced Extraction Process",
        description: "Ensuring the highest purity and intensity of flavor and aroma."
      },
      {
        title: "Versatility",
        description: "Suitable for a wide range of applications across various industries."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262420/sahaj/products/oil/Pepper_Oleoresins.png')` // Black Peppercorns imagery
          }}
        ></div>
...
export default PepperOleoresins;

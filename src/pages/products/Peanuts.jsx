...
const Peanuts = () => {
  // Hardcoded Product Data for Peanuts
  const product = {
    id: "peanuts",
    name: "Peanuts",
    description: "Our Select Harvest Peanuts are a premium offering, carefully sourced from the most fertile regions known for their quality groundnut production. These peanuts are cultivated using sustainable farming practices, ensuring both environmental responsibility and superior quality.",
    specifications: {
      "Quality": "Handpicked, Non-GMO, and naturally grown",
      "Packaging": "Available in various packaging options including vacuum-sealed bags, jute bags, and bulk orders, ranging from small packets (100g, 500g) to large sacks (25kg, 50kg)",
      "Shelf Life": "6-12 months depending on storage conditions",
      "Grade": "Available in different grades catering to various market needs",
      "Nutritional Value": "Rich in protein, healthy fats, vitamins E and B group, and minerals like magnesium and phosphorous",
      "Uses": "Ideal for direct consumption, culinary uses, oil extraction, and as an ingredient in confectionery and bakery products",
      "Certifications": "ISO Certified, Food Safety Standards Compliance"
    },
    exportCapabilities: {
      "Minimum Order Quantity": "Negotiable, with flexible order sizes to accommodate different needs",
      "Shipping": "Efficient global shipping capabilities with adherence to international standards",
      "Customs Handling": "Assistance with export documentation and customs processes"
    },
    coreValues: [
      {
        title: "Superior Taste and Quality",
        description: "Our peanuts are recognized for their exceptional flavor and freshness."
      },
      {
        title: "Strict Quality Control",
        description: "Rigorous quality checks and processing standards ensure the finest product reaches you."
      },
      {
        title: "Customization and Flexibility",
        description: "We offer tailored solutions in packaging and product specifications to meet diverse market demands."
      }
    ]
  };
    ...
    <div className="pb-32 min-h-screen bg-noise">
      ...
      <div className="relative w-full h-[85vh] min-h-[600px] mb-24 flex items-center">
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url('https://res.cloudinary.com/dvdd218yw/image/upload/f_auto,q_auto,w_1920/v1781262411/sahaj/products/agro/penaut.png')` // High quality peanuts photo
          }}
        ></div>

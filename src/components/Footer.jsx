...
const Footer = () => {
  return (
    <footer className="bg-primary-dark relative pt-20 pb-6 px-6 md:px-16 lg:px-24 overflow-hidden border-t border-white/10" id="footer">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center gap-4 group">
        ...
        <a 
          ...
          target="_blank" 
          rel="noreferrer"
          className="w-12 h-12 md:w-14 md:h-14 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300"
        >
